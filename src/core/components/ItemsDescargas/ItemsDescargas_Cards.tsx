...
export default class ItemsDescargas_Cards extends React.Component<IItemsDescargasProps, IItemDescargaState> {
  public constructor(props: ItemsDescargas_Cards) {
    super(props);
